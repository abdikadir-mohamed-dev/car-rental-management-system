...
import { fetchEarnings, fetchEarningsSummary } from '../../redux/slices/driverSlice'
...
export default function DriverEarningsPage() {
  ...
  const { earnings, earningsSummary, loading } = useSelector((state) => state.driver)
  const [period, setPeriod] = React.useState('week');

  useEffect(() => {
    dispatch(fetchEarnings({ period }))
    dispatch(fetchEarningsSummary({ period }))
  }, [dispatch, period])
