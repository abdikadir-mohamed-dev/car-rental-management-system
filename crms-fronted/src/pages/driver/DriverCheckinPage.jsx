...
const MOCK_ACTIVE = [
  { _id: 'BKG-1020', customer: 'Mary Wanjiku', vehicle: 'Volkswagen Golf', dropoffDate: '2026-08-20', dropoffLocation: 'Lavington', status: 'active' },
]

function DriverCheckinPage() {
  const [bookings] = useState(MOCK_ACTIVE)
          ...
          <tbody>
            {filtered.map((booking) => (
              <tr key={booking._id} className="border-b border-slate-100 hover:bg-slate-50">
                ...
                <td className="py-3 px-4 text-slate-600">{booking.dropoffLocation}</td>
