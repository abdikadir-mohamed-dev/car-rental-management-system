...
function VehicleDetailsPage() {
    ...
    const loadData = async () => {
      try {
        ...
        try {
          ...
          console.error(
            'Failed to check saved car status:',
            savedError
          )

          /*
           * Do not prevent the vehicle page from loading
           * just because the saved-car check failed.
           */
          setLiked(false)
        }
      } catch (err) {
  ...
  const handleToggleSave = async () => {
    ...
    try {
      ...
      if (liked) {
        /*
         * Vehicle is currently saved.
         * Remove it from PostgreSQL.
         */
