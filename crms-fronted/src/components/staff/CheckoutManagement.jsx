...
import { Search, CheckCircle, XCircle, User, CreditCard } from 'lucide-react'
import toast from 'react-hot-toast'

const MOCK_BOOKINGS = [
  { _id: 'BKG-1024', customer: { name: 'Alice Mwangi', email: 'alice@example.com', phone: '+254 711 111 111', licenseNumber: 'DL-12345', licenseExpiry: '2027-05-20' }, vehicle: { name: 'Toyota RAV4' }, pickupDate: '2026-08-20', dropoffDate: '2026-08-25', status: 'confirmed', pickupLocation: 'Nairobi CBD' },
  { _id: 'BKG-1023', customer: { name: 'Brian Otieno', email: 'brian@example.com', phone: '+254 722 222 222', licenseNumber: 'DL-67890', licenseExpiry: '2026-12-15' }, vehicle: { name: 'Mazda CX-5' }, pickupDate: '2026-08-21', dropoffDate: '2026-08-28', status: 'confirmed', pickupLocation: 'Westlands' },
]
...
function CheckoutManagement() {
  ...
  const confirmCheckout = () => {
    if (!idConfirmed || !licenseConfirmed) {
      toast.error('Please confirm ID and driver\'s license')
      return
    }
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Verify customer photo ID matches reservation</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-slate-900">Driver's License</p>
                      <p className="text-xs text-slate-500">License: {selectedBooking.customer?.licenseNumber || 'N/A'} | Expires: {selectedBooking.customer?.licenseExpiry || 'N/A'}</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
