...
const adminLinks = [
  ...
  { to: '/admin/rental-policies', icon: 'FileText', label: 'Rental Policies' },
...
function Sidebar({ isOpen, onClose, role }) {
  ...
  const getIcon = (iconName) => {
    const icons = {
      ...
      FileText: () => <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zM14 2v6h6M16 13H8M16 17H8M10 9H8" /></svg>,
